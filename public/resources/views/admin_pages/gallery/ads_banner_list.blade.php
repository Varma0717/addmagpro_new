              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        @foreach($ads_banner as $index=>$gallery_detail)
                        <tr>
                          <td>{{$index+1}}</td>
                          ...
                          <td><a href="{{route('update_adsbanner_gallery',['gallery_id'=>$gallery_detail->ads_banner_id])}}" class="badge badge-primary">Update</a>
                          </td>
                        </tr>
                        @endforeach
                      </table>
                  ...
                  <div class="card-footer text-right">
                    @include('admin_pages.partials.pagination', ['paginator' => $ads_banner])
                  </div>
