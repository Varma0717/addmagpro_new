              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        @foreach($banners as $index=>$banner_detail)
                        <tr>
                          <td>{{$index+1}}</td>
                          ...
                          <td><a href="{{route('update_bannner',['banner_id'=>$banner_detail->banner_id])}}" class="badge badge-primary">Update</a>
                          </td>
                  ...
                  <div class="card-footer text-right">
                    @include('admin_pages.partials.pagination', ['paginator' => $banners])
                  </div>
