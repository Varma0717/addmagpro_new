              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered table-md">
                        ...
                        <tr>
                          ...
                          <td><a href="{{route('category_update_admin',['category_id'=>$category_detail->id])}}" class="badge badge-primary">Update</a>
                          </td>
                  ...
                  <div class="card-footer text-right">
                    @include('admin_pages.partials.pagination', ['paginator' => $category_details])
                  </div>
