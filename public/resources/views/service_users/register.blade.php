            ...
            <div class="container">
                ...
                <div class="navbar-collapse offcanvas-collapse" id="navbarsExampleDefault">
                    <!-- <ul class="navbar-nav ms-auto navbar-nav-scroll">
                        ...
                        <li>
                            <span class="nav-item">
                                <a href="login" class="btn-outline-sm" href="log-in.html">Log in</a>
                            </span> 
                        </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-10 offset-xl-1">
                        ...
                        <h5 class="text-center"><b>REFERRED BY : {{  strtoupper($referal_name)}}</b></h5>
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            </div> <!-- end of container -->
                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        <div class="text-box mt-5 mb-5">
                            <p class="mb-4">Already Have an Account? Then please <a class="blue" href="{{route('landingpage')}}">Login</a></p>
                            ...
                            <form action="{{route('service_user_registration')}}" method="POST">
                                ...
                                <div class="mb-4 form-floating">
                                    ...
                                    <input type="text" class="form-control" id="member_name" placeholder="name@example.com" name="member_name">
                                    <label for="floatingInput">Member Name</label>
                                    <span style="color:red">@error('member_name'){{$message}}@enderror</span>
                                </div>
                                <div class="mb-4 form-floating">
                                    <input type="number" class="form-control" id="mobile_no" placeholder="name@example.com" name="mobile_no">
