...
<div class="page-content">
    ...
    <div class="container">
      <div class="text-center pb-3">
        <div class="row mt-4">
            ...
            <h3 class="mb-0 h3 fw-bold mt-4">Stores</h3>
         ...
         <div class="service-card col-md-2 mx-auto">
          <div class="row">
            <div class="product-image d-flex justify-content-center mt-3">
              <img src="./assets/user_assets/images/avatars/01.webp" alt=""  class="img-fluid">
            </div>
            <div class="card-body">
              <h5 class="product-name text-center fw-bold">
                lawyer
  ...
  <div class="col-12">
    ...
    <div class="container d-flex justify-content-center">
        ...
        <a href="{{route('adding_store')}}"><button class="btn btn-lg btn-dark">list Your bussiness</button></a>
