...
<div class="page-content">
  ...
  <section class="section-padding">
    <div class="container">
      <div class="separator pb-3">
        <div class="line"></div>
        <h3 class="mb-0 h3 fw-bold" id="type-advertise" name="type-advertise">Services</h3>
        <div class="line"></div>
      </div>
  ...
  <div class="col-12">
    ...
    <div class="container d-flex justify-content-center">
        ...
        <a href="{{route('adding_service')}}"><button class="btn btn-lg btn-dark"> <i class="bi bi-plus"></i> list Your bussiness</button></a>
