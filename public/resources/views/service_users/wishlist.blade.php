    ...
    <nav class="navbar navbar-expand-xl w-100 navbar-dark container gap-3">
      ...
      <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasNavbar">
        <div class="offcanvas-header">
          <div class="offcanvas-logo"><img src="assets/user_assets/images/logo.png" class="logo-img" alt="">
          </div>
    ...
    <div class="container">
      <div class="d-flex align-items-center px-3 py-2 border mb-4">
        <div class="text-start">
          <h4 class="mb-0 h4 fw-bold">Wishlist ({{$wishlist_count}} Items)</h4>
       </div>
       <div class="ms-auto">
      ...
      <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4 row-cols-xxl-5 g-4">
        ...
        <div class="col">
          <div class="card rounded-0">
            <a href="/remove_item_wishlist/{{$wishlist_product->product_id}}" class="btn-close wishlist-close position-absolute end-0 top-0"></a>
            <a href="javascript:;">
              <img src="{{asset($wishlist_product->product_images)}}" alt="" class="card-img-top rounded-0">
            </a>
            <div class="card-body border-top text-center">
              <p class="mb-0 product-short-name">{{$wishlist_product->product_name}}</p>
              <div class="product-price d-flex align-items-center gap-2 mt-2 justify-content-center">
                <div class="h6 fw-bold">{{$wishlist_product->purchase_price}}</div>
                <div class="h6 fw-light text-muted text-decoration-line-through">{{$wishlist_product->unit_price}}</div>
                <div class="h6 fw-bold text-danger">(70% off)</div>
              </div>
            </div>
            <div class="card-footer bg-transparent text-center">
              <a href="/add_to_cart/{{$wishlist_product->product_id}}" class="btn btn-ecomm w-100">Move to Bag</a>
            </div>
          </div>
        </div>
        @endforeach
