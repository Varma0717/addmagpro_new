  ...
  <header class="top-header">
    <nav class="navbar navbar-expand-xl w-100 navbar-dark container gap-3">
      ...
      <ul class="navbar-nav secondary-menu flex-row  d-flex align-items-center">
        ...
        <li class="nav-item">
          <a class="nav-link" href="{{route('user_dashboard')}}"><img src="{{asset('assets/user_assets/images/avatars/01.webp')}}" alt="no-image" style="max-width: 50px; border-radius: 100%; align-self: center;" class="profile-img"></a>
        </li>
      </ul>
    </nav>
  </header>
  ...
  <section class="section-padding">
    <div class="container">
      <div class="separator pb-3">
        <div class="line"></div>
        <h3 class="mb-0 h3 fw-bold" id="type-advertise" name="type-advertise">Classifieds</h3>
        <div class="line"></div>
      </div>
      <div class="similar-products service-profile ">
      <div class="row">
...
<div class="col-md-6">
  ...
  <div class="col-12">
    ...
    <div class="container d-flex justify-content-center">
        ...
        <a href="{{route('adding_classified')}}"><button class="btn btn-lg btn-dark"> <i class="bi bi-plus"></i> list Your bussiness</button></a>
