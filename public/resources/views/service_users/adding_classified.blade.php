    ...
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0"> 
          ...
          <li class="breadcrumb-item"><a href="javascript:;">Classifieds</a></li>
                  ...
                  @csrf
                    <div class="row g-3">
                      ...
                      <div class="col-6">
                          ...
                          <input type="hidden" id="business_type" name="business_type" value="2">
                      </div>
                     ...
                     <div class="col-md-4 col-12">
                      ...
                      <div class="col-8">
                        ...
                        <select name="profession" id="profession" class="form-control rounded-0">
                          ...
                          <option value="{{$services_detail['id']}}">{{$services_detail['classified_name']}}</option>
                          @endforeach
                        </select>
                      </div>
                     <div class="row g-3">
                      ...
                      <div class="col-12">
                          ...
                          <button type="button" class="btn btn-dark rounded-0 btn-ecomm w-100" id="razorpay-button">Pay( 100 ) </button>
                      </div>
                      <!---end row-->
                 </form>
...
<script>
    document.getElementById('razorpay-button').onclick = function(e) {
        e.preventDefault();
        if (document.getElementById('pannumber').value && document.getElementById('pincode').value && document.getElementById('bankname').value && document.getElementById('accountnumber').value && document.getElementById('ifsccode').value && document.getElementById('description').value) {
            var options = {
                "key": "{{ env('RAZORPAY_KEY_ID') }}",
                "amount": 10000, // Amount is in paise
                "currency": "INR",
