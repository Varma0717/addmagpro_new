                ...
                <div class="row">
                    <div class="col-xl-6 offset-xl-3">
                        <div class="text-box mt-5 mb-5">
                            <p class="mb-4">You don't have a Account? Then please <a class="blue" href="service_user_registration">Register Here</a></p>

                            <!-- Log In Form -->
                            <form action="{{route('service_user_login')}}" method="POST">
                                @csrf
                                <div class="mb-4 form-floating">
                                    <input type="number" class="form-control" id="mobile_no" placeholder="name@example.com" name="mobile_no" required>
