    ...
    <div class="container">
      <div class="text-center pb-3">
        <div class="row mt-4">
            ...
            <h3 class="mb-0 h3 fw-bold mt-4">Classifieds</h3>
        ...
        @foreach($classifieds as $classified)
            ...
            <div class="row">
              <div class="product-image d-flex justify-content-center mt-3">
                <img src="{{$classified->classified_image}}" alt=""  class="img-fluid">
              </div>
              <a href="{{route('classified_fullview',['service_id'=>$classified->id])}}" class="card-body">
