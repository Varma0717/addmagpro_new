                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">New Category</h5>
                                            <p class="m-b-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="card">
                                    ...
                                    <div class="card-block row">
                                        <form class="form-material col-md-6" id="imageForm" action="new_category_added" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            ...
                                            <div class="form-group form-default">
                                                ...
                                                <div id="imageDisplay"><img src="{{asset('assets/images/img2.jpg')}}" alt="" width="150px" height="150px"></div>
                                            </div>
