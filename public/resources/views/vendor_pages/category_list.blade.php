                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="vendor_category_list">Category List</a>
                                            </li>
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tbody>
                                                @foreach($category_details as $index=>$category_details)
                                                <tr>
                                                    <td>{{$index+1}}</td>
                                                    <td>
                                                        
                                                        <div class="d-inline-block align-middle">
                                                            <img src="{{$category_details->ImageURL}}" alt="user image" class="img-radius img-80 align-top m-r-15">
                                                           
                                                        </div>
                                                    </td>
                                                    <td>{{$category_details->CategoryName}}</td>
                                                    
                                                    <td class="text-right"><label class="label label-success">High</label></td>
                                                    <td>
                                                        <div class="text-right">
                                                            <!-- <a href="vendor_category_update" class="pcoded-micon m-2" style="cursor: pointer;">
                                                                <i class="ti-pencil" style="color: rgb(255, 145, 0); font-size: 20px;"></i>
                                                            </a> -->
                                                            <!-- <span class="pcoded-micon m-2" style="cursor: pointer; "><i class="ti-pencil" style="color: rgb(255, 145, 0); font-size: 20px;"></i></span> -->
                                                            <a href="/vendor_category_update/{{$category_details->id}}" class="pcoded-micon m-2" style="cursor: pointer;"><i class="ti-pencil" style="color: red; font-size: 20px;"></i></span>
                                                            <a href="/vendor_category_delete/{{$category_details->id}}" class="pcoded-micon m-2" style="cursor: pointer;"><i class="ti-trash" style="color: red; font-size: 20px;"></i></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
