                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Vendor Banner</h5>
                                            <p class="m-b-0"></p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="vendor_category_list">Vendor Banner</a>
                                            </li>
                                    ...
                                    <div class="card-block">
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tr>
                                                    <th> Vendor Banner</th>
                                                    <th class="text-right">Update Banner</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="d-inline-block align-middle">
                                                            <img src="{{$category_details->ImageURL}}" alt="user image"  width="150px" height="150px">
                                                    ...
                                                    <td>
                                                        <div class="text-right">
                                                            ...
                                                            <a href="{{route('vendor_banner_update',['vendor_id'=>$category_details->vendor_id])}}" class="pcoded-micon m-2" style="cursor: pointer;"><i class="ti-pencil" style="color: red; font-size: 20px;"></i></span>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
