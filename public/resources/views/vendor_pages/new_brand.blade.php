                            ...
                            <div class="col-md-12 mt-5">
                                <div class="card">
                                    ...
                                    <div class="card-block row">
                                        <form class="form-material col-md-6" id="imageForm" action="add_new_brand" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group form-default">
                                                <input type="text" name="brand_name" class="form-control" required id="brand_name">
                                            ...
                                            <!-- <div class="form-group col-md-12 d-flex justify-content-start" >
                                                ...
                                                <input type="file" name="brand-image" class="form-control-file col-md-12" required id="brand-image" style="border:1px black solid ;" >
                                                <span class="form-bar"></span>
                                               
                                               
                                            </div> -->
                                            <div class="form-group form-default">
                                                <input type="file" id="brand_image" accept="image/*" onchange="displayImage(event)" name="brand_image" required>
                                                <div id="imageDisplay"><img src="assets/images/img2.jpg" alt="" width="150px" height="150px"></div>
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <!-- <div class="container">
                                            <img src="" alt="category-image" class="img-fluid">
                                        </div> -->
                                    </div>
                                    </div>
                                </div>
