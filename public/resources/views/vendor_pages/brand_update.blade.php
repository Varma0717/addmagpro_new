                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!"> Brand Editing</a>
                                            </li>
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="card">
                                    ...
                                    <div class="card-block row">
                                        <form class="form-material col-md-6" action="{{route('vendor_brand_update')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group form-default">
                                                ...
                                                <input type="text" name="brand_name" class="form-control" required id="brand_name" value="{{$brand_info->brand_name}}">
