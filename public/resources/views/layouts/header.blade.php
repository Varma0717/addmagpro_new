...
<head>
  ...
  <title>Add MaG Pro - Admin Dashboard Template</title>
  <!-- General CSS Files -->
        ...
        <ul class="navbar-nav navbar-right">
              ...
              <div class="dropdown-list-content dropdown-list-icons">
                <a href="#" class="dropdown-item dropdown-item-unread"> <span
                    ...
                    clean it! <span class="time">17 Hours Ago</span>
												...
												fa-bell"></i>
                  </span> <span class="dropdown-item-desc"> Welcome to Add MaG Pro
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown"
            ...
            <div class="dropdown-menu dropdown-menu-right pullDown">
              ...
              <a href="/admin_profile" class="dropdown-item has-icon"> <i class="far
										fa-user"></i> Profile
              </a> <a href="home" class="dropdown-item has-icon"> <i class="fas fa-bolt"></i>
                Activities
              </a> <a href="home" class="dropdown-item has-icon"> <i class="fas fa-cog"></i>
                Settings
              </a>
              <div class="dropdown-divider"></div>
              <a href="/admin_logout" class="dropdown-item has-icon text-danger"> <i class="fas fa-sign-out-alt"></i>
                Logout
              </a>
            </div>
          </li>
