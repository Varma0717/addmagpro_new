...
document.querySelectorAll(".dropdown-box .dropdown-menu a").forEach(function (element) {
    element.addEventListener("click", function (event) {
        ...
        var dropdownToggle = dropdownMenu ? dropdownMenu.previousElementSibling : null;
        var dropdownLabel = dropdownToggle ? dropdownToggle.querySelector("span") : null;
        if (dropdownLabel) dropdownLabel.textContent = getSampling;
    });
});
...
if (productList) productList.addEventListener('click', function (event) {
...
function enableAccordion() {
    ...
    footerTitle.forEach(function (title) {
        if (!title.querySelector(".according-menu")) {
            ...
            const headingEl = title.querySelector("h4, h5");
            if (!headingEl) return;
...
if (searchInputBox) searchInputBox.addEventListener("click", () => {
...
function CheckProductQuantity() {
    ...
    if (AllProducts.length === 0) {
        ...
        if (emptyCard) emptyCard.classList.add("show");
    }
}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!localStorage.getItem("modalShown") && newsletterModalEl && typeof bootstrap !== "undefined") {
        var myModal = new bootstrap.Modal(newsletterModalEl);
        myModal.show();
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!exitModalEl || typeof bootstrap === "undefined") return;
...
/*====================
    21. Page Loader Js
=======================*/
const hasLoaderDeps = typeof gsap !== "undefined" && typeof SplitType !== "undefined";
const preloaderEl = document.querySelector(".preloader");
const progressBarEl = document.querySelector(".preloader-progress-bar");
const hasLoaderDom = preloaderEl && progressBarEl && document.querySelector(".loading-text.initial") && document.querySelector(".loading-text.complete");

if (hasLoaderDeps && hasLoaderDom) {
