        ...
        <div class="col-xl-4 col-lg-6 col-md-8">
          <div class="stat-card">
            ...
            <div class="stat-info flex-grow-1">
              ...
              <a href="<?php echo e(route('backtwoback_amount_settle')); ?>" class="btn btn-theme btn-sm">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admagpro\resources\views/admin_pages/backtwoback_settle.blade.php ENDPATH**/ ?>