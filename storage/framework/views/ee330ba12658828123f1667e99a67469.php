<?php $__env->startSection('page_title', 'My Dashboard | AddMagPro'); ?>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 col-xl-2">
                <div class="dash-card p-0 overflow-hidden">
                    ...
                    <div class="p-2">
                        <a href="<?php echo e(route('user_dashboard')); ?>" class="sidebar-dash-link active">
                            <i class="ri-dashboard-line"></i>Dashboard
                        </a>
                        <a href="<?php echo e(route('generate_coupon')); ?>" class="sidebar-dash-link">
                            <i class="ri-coupon-line"></i>Generate Coupons
                        </a>
                        <a href="<?php echo e(route('user_wallet')); ?>" class="sidebar-dash-link">
            ...
            <div class="col-lg-9 col-xl-10">
                ...
                <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
                    <div>
                        <h4 class="fw-bold mb-0">Welcome, <?php echo e($user_details[0]->member_name ?? 'Member'); ?>!</h4>
                    ...
                    ?>
                    <span class="level-badge" style="background:<?php echo e($levelColor); ?>;color:#fff;">
                        <i class="ri-medal-line me-1"></i><?php echo e($level); ?> Member
                    </span>
                </div>
                <?php endif; ?>
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:.75rem;margin-bottom:1.25rem;">
                    <div class="dash-stat" style="background:linear-gradient(135deg,#aa5500,#7a2800);">
                        ...
                        <div>
                            <h3>&#8377;<?php echo e(number_format($cummulative_value ?? 0, 0)); ?></h3>
                            <p>Total Wallet</p>
                        </div>
                    </div>
                    <div class="dash-stat" style="background:linear-gradient(135deg,#1976d2,#0d47a1);">
                        ...
                        <div>
                            <h3>&#8377;<?php echo e(number_format($my_commission ?? 0, 0)); ?></h3>
                            <p>Commission</p>
                        </div>
                    </div>
                    <div class="dash-stat" style="background:linear-gradient(135deg,#388e3c,#1b5e20);">
                        ...
                        <div>
                            <h3>&#8377;<?php echo e(number_format($back_two_back_balance_value ?? 0, 0)); ?></h3>
                            <p>B2B Balance</p>
                        </div>
                    </div>
                    <div class="dash-stat" style="background:linear-gradient(135deg,#7b1fa2,#4a148c);">
                        ...
                        <div>
                            <h3><?php echo e($discount_vendor_count ?? 0); ?></h3>
                ...
                <div class="dash-card mb-4">
                    ...
                    if ($gross < 8000) { $nextLevel=8000; $nextName='Bronze' ; }
                        ...
                        <small>Cumulative Gross: <strong>&#8377;<?php echo e(number_format($gross, 0)); ?></strong></small>
                        <small>Next Level: <strong><?php echo e($nextName); ?></strong> (&#8377;<?php echo e(number_format($nextLevel, 0)); ?>)</small>
                </div>
                <div class="progress" style="height:12px;border-radius:6px;">
                    <div class="progress-bar" style="width:<?php echo e($pct); ?>%;background:var(--theme-color);border-radius:6px;"><?php echo e($pct); ?>%</div>
                </div>
                <small class="text-muted mt-1 d-block">Commission Rate: <strong><?php echo e($user_details[0]->commission_percentage ?? 0); ?>%</strong></small>
            </div>
            <?php endif; ?>
            ...
            <div class="dash-card">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(110px,1fr));gap:.75rem;">
                    <a href="<?php echo e(route('products_list')); ?>" class="text-center p-3 rounded border text-decoration-none" style="color:var(--title-color);">
                    ...
                    <a href="<?php echo e(route('team_details')); ?>" class="text-center p-3 rounded border text-decoration-none" style="color:var(--title-color);">
                        <i class="ri-team-line d-block mb-1" style="font-size:1.8rem;color:var(--theme-color);"></i>
                        <small class="fw-semibold">My Team</small>
                    </a>
                    <a href="<?php echo e(route('withdraw_amount')); ?>" class="text-center p-3 rounded border text-decoration-none" style="color:var(--title-color);">
                    ...
                    <a href="<?php echo e(route('account_orders')); ?>" class="text-center p-3 rounded border text-decoration-none" style="color:var(--title-color);">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('service_user_dashboard_layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\admagpro\resources\views/service_users/user_dashboard.blade.php ENDPATH**/ ?>