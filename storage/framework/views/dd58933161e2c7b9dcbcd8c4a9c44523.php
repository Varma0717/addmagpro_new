<nav class="admin-topbar" id="adminTopbar">
    ...
    <div class="topbar-right">
        <a href="<?php echo e(route('welcome_page')); ?>" class="topbar-icon-btn" target="_blank" title="View Website">
        ...
        <div class="topbar-user-dropdown dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-end">
                <li>
                    <a class="dropdown-item text-danger" href="<?php echo e(route('admin_logout')); ?>">
...
<?php /**PATH C:\xampp\htdocs\admagpro\resources\views/layouts/header.blade.php ENDPATH**/ ?>