                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <ul class="breadcrumb-title">
                                            ...
                                            <li class="breadcrumb-item"><a href="#!"> Vendor Banner Update</a>
                                            </li>
                            ...
                            <div class="col-md-12 mt-5">
                                <div class="card">
                                    <div class="card-header">
                                        <h5>Vendor Banner Update</h5>
                                        <!--<span>Add class of <code>.form-control</code> with <code>&lt;input&gt;</code> tag</span>-->
                                    </div>
                                    <div class="card-block row">
                                        <form class="form-material col-md-6" action="{{route('vendor_banner_update_modify')}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group form-default">
                                                <input type="hidden" name="category_id" id="category_id" value="{{$category_info->vendor_id}}">
