                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                   ...
                                   <div class="conatiner">
                                     ...
                                     <form action="{{route('product_update_submit')}}" method="POST" class="form-material" enctype="multipart/form-data">
                                        @csrf
                                        <div class="container">
                                            <div class="col-12 card pt-5">
                                                ...
                                                <div class="form-group form-default py-4">
                                                    ...
                                                    <input type="hidden" name="product_id" class="form-control" id="product_id" value="{{$product->product_id}}">
                                                    <input type="hidden" name="vendor_id" class="form-control" id="vendor_id" value="{{$product->vendor_id}}">
                                                ...
                                                <h5>General setup</h5>
                                                 ...
                                                 <div class="row">
                                                        ...
                                                        <select name="category" id="category" value="select category" class="form-control">
                                                          <option value="{{$category[0]->id}}">{{$category[0]->CategoryName}}</option>
                                                       ...
                                                       <div class="col-md-3 py-4">
                                                        ...
                                                        <select name="brand" id="brand" value="select brand" class="form-control">
                                                          <option value="{{$brand[0]->id}}">{{$brand[0]->brand_name}}</option>
                                                          @foreach($brands as $brand_detail)
                                                       ...
                                                       <div class="col-md-3 py-4">
                                                        ...
                                                        <input type="text" class="form-control" placeholder=" Item code" id="item_code" name="item_code" value="{{$product->item_code}}">
                                                        <span class="form-bar"></span>
                                                       </div>
                                            ...
                                            <div class="col-12 card p-4">
                                               ...
                                               <div class="row">
                                                ...
                                                <div class="form-group form-default col-md-3 py-4">
                                                    ...
                                                    <input type="text" name="purchase_price" class="form-control" required id="purchase_price" value="{{$product->purchase_price}}">
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Purchase Price(₹) <span style="color: red;">*</span></label>
                                                </div>
                                                <div class="form-group form-default col-md-3 py-4">
                                                    
                                                    <input type="text" name="unit_price" class="form-control" required id="unit_price" value="{{$product->unit_price}}">
                                                    <span class="form-bar"></span>
                                        ...
                                        <div class="col-12 card p-5">
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-6" id="imageDisplay">
                                                   <img src="{{asset($product->product_images)}}" alt="product-thumbnail" style="width: 250px; height: 250px;">
                                                </div>
