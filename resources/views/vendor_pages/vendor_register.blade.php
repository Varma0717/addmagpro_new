    ...
    <!-- end of navigation -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="footer-col first">
                            <h6>About Website</h6>
                            <p class="p-small">We are delighted to introduce you to Add Mag Pro, a leading E-commerce and Local Search Engine platform designed to help businesses like yours reach a broader audience and grow your customer base. Our website features a wide array of product categories including clothes, electronics, groceries, electric vehicles..etc and service categories , offering a one-stop shop for consumers and a lucrative marketplace for vendors.</p>
                        </div> <!-- end of footer-col -->
                        <div class="footer-col second">
                            <h6>Links</h6>
                            <ul class="list-unstyled li-space-lg p-small">
                                <li>Important: <a href="{{route('terms_and_conditions')}}">Terms & Conditions</a>, <a href="{{route('privacy_policy')}}">Privacy Policy</a></li>
                        ...
                        <div class="footer-col third">
                            ...
                            <p class="p-small">For Any Queries Mail to <a href="mailto:contact@addmagpro.com"><strong>contact@addmagpro.com</strong></a></p>
                        </div> <!-- end of footer-col -->
                    </div> <!-- end of col -->
                </div> <!-- end of row -->
            </div> <!-- end of container -->
        ...
        <div class="copyright">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p class="p-small">Copyright © <a href="https://varatechnologies.in/">Vara Technologies</a></p>
                    </div> <!-- end of col -->
                    <div class="col-lg-6">
