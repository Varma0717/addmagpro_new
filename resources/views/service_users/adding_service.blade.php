...
@section('page_title', 'List Your Service | AddMagPro')
@section('extra_css')
<style>
    ...
    <div class="custom-container">
        <div class="breadcrumb-head">
            <nav><ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">List Your Service</li>
            </ol></nav>
        </div>
    </div>
</section>
<section class="section-b-space">
    <div class="custom-container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h4 class="fw-bold mb-4 text-center">Business Service Listing</h4>
                <p class="text-center text-muted mb-4">Register your business to get listed in the AddMagPro service directory. One-time registration fee: <strong style="color:var(--theme-color);">&#8377;1050</strong></p>
                <form action="{{ route('razorpay') }}" method="POST" enctype="multipart/form-data" id="payment-form">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="mt-2 text-center">
                                    <img id="previewImg" src="{{ asset('assets/images/img2.jpg') }}" style="width:100px;height:100px;border-radius:50%;object-fit:cover;border:2px solid var(--theme-color);">
                                </div>
                            </div>
                    ...
                    <div class="form-card">
                        <h6><i class="ri-map-pin-line me-2"></i>Location Details</h6>
                        <div class="row g-3">
                            <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <label class="form-label fw-semibold">Select Profession</label>
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="description" name="description" placeholder="Brief about your service" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-card">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 d-flex align-items-end">
                                <button type="button" class="btn w-100" style="background:var(--theme-color);color:#fff;" id="validate-coupon">Apply Coupon</button>
                            </div>
                            <div class="col-12">
                                <span id="coupon-error" class="text-danger d-none"><i class="ri-error-warning-line me-1"></i>Invalid coupon code.</span>
                                <span id="coupon-success" class="text-success d-none"><i class="ri-check-line me-1"></i>Coupon applied! Pay only &#8377;1.</span>
                            </div>
                            <div class="col-12">
