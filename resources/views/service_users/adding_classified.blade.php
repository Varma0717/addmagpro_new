...
@section('page_title', 'Post Classified | AddMagPro')
@section('extra_css')
<style>
    ...
    <div class="custom-container">
        <div class="breadcrumb-head">
            <nav><ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('classifieds_list') }}">Classifieds</a></li>
                <li class="breadcrumb-item active">Post Classified</li>
            </ol></nav>
        </div>
    </div>
</section>
<section class="section-b-space">
    <div class="custom-container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <h4 class="fw-bold mb-4 text-center">Post a Classified</h4>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                ...
                                <select name="profession" class="form-control" required>
                                    ...
                                    <option value="{{ $s->id }}">{{ $s->classified_name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-12">
                                <label class="form-label fw-semibold">Description</label>
                                <input type="text" class="form-control" id="description" name="description" placeholder="Brief description" required>
                            </div>
                        </div>
                    </div>
