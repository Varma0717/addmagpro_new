...
@section('page_title', 'Classified Listings | AddMagPro')
@section('mainsection')
...
<section class="section-b-space">
    <div class="custom-container">
        <h4 class="fw-bold mb-4">Classified Listings</h4>
        <div class="row g-4">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="card h-100 border-0 shadow-sm" style="border-radius:12px;overflow:hidden;">
                    ...
                    @else
                    <div style="width:100%;height:180px;background:linear-gradient(135deg,#2196F3,#0d47a1);display:flex;align-items:center;justify-content:center;">
                        <i class="ri-newspaper-line" style="font-size:3rem;color:#fff;"></i>
                    </div>
                    @endif
                    <div class="card-body">
            ...
            <div class="col-12 text-center py-5">
                <i class="ri-newspaper-line" style="font-size:3rem;color:#ccc;"></i>
                <p class="text-muted mt-2">No classified listings found.</p>
            </div>
            @endforelse
        </div>
    </div>
