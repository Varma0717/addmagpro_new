...
@section('mainsection')
      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h2 class="mb-0 fw-bold" style="font-size:1.4rem;">Add New Banner</h2>
        </div>
      </div>
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card admin-card">
                  <div class="card-header admin-card-header">
                    ...
                    <form action="{{route('new_banner_added')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                      ...
                      <div class="admin-form-group">
                        ...
                        <select class="form-control admin-input" id="banner_name" name="banner_name">
                          <option value="mainslider1">Main Slider1</option>
                      ...
                      <div class="admin-form-group">
                        ...
                        <input type="file" id="banner_image" name="banner_image" accept="image/*" onchange="displayImage(event)" required>
