...
@section('mainsection')
      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h2 class="mb-0 fw-bold" style="font-size:1.4rem;">Add New Classified</h2>
        </div>
      </div>
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card admin-card">
                  <div class="card-header admin-card-header">
                    <h4>Add New Classified</h4>
                  </div>
                    <form action="{{route('new_classified_added')}}" method="POST" enctype="multipart/form-data">
                    @csrf
