...
@section('page_title', 'Rejected Stores | AddMagPro Admin')
@section('mainsection')
  ...
  <section class="admin-section">
    <div class="admin-section-body">
      <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
          <h2 class="admin-page-title">Rejected Stores</h2>
          <p class="admin-page-subtitle">Product vendors that were not approved.</p>
        </div>
      </div>

      <div class="card admin-card">
        <div class="card-header admin-card-header">
          <h4><i class="ri-close-circle-line me-2"></i>Rejected Product Vendors</h4>
        </div>
          ...
          <div class="table-responsive admin-table-wrap">
            <table class="table admin-table align-middle mb-0">
              ...
              <tbody>
                ...
                @empty
                  <tr><td colspan="9" class="text-center text-muted py-4">No rejected stores found.</td></tr>
                @endforelse
              </tbody>
            </table>
          </div>
