    ...
    <div class="admin-section-body">
      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          ...
          <p class="text-muted mb-0 small">Welcome back, {{ session('admin_username') }}</p>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <div class="stat-value">{{$total_turn_over}}</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <div class="stat-value">{{$admin_commission}}</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <div class="stat-value">{{$admin_wallet['charity']}}</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <div class="stat-value">{{$admin_wallet['monthly_pool']}}</div>
            </div>
          </div>
        </div>
        ...
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="stat-card">
            ...
            <div class="stat-info">
              ...
              <div class="stat-value">{{$admin_wallet['backtwoback']}}</div>
            </div>
          </div>
        </div>

        {{-- Back 2 Back Outstanding --}}
        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
          <div class="stat-card">
            <div class="stat-icon blue"><i class="ri-funds-line"></i></div>
            <div class="stat-info">
              <div class="stat-label">B2B Outstanding</div>
              <div class="stat-value">{{$back2back_outstanding}}</div>
            </div>
          </div>
        </div>
