...
@section('mainsection')
      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h2 class="mb-0 fw-bold" style="font-size:1.4rem;">Vendor Pending Withdrawal</h2>
        </div>
      </div>
            <div class="row">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card admin-card">
                  <div class="card-header admin-card-header">
                    <h4>Vendor Pending Withdrawal</h4>
                  </div>
                    ...
                    <div class="table-responsive">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="{{route('update_vendor_withdrawal_request',['user_id'=>$accepted_withdrawal->request_id])}}" class="status-badge badge-rejected">Update</a>
                          </td>
                        </tr>
                        @empty
