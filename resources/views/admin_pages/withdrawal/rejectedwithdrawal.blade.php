...
@section('mainsection')
      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
          <h2 class="mb-0 fw-bold" style="font-size:1.4rem;">Rejected Withdrawal</h2>
        </div>
      </div>
            <div class="row">
                  ...
                  <div class="card-body admin-card-body p-0">
                    <div class="table-responsive">
                      <table class="table admin-table align-middle mb-0">
                        ...
                        <tbody>
                        @forelse($rejected_withdrawals as $index=> $accepted_withdrawal)
                        <tr>
                          <td>{{$index+1}}</td>
