      ...
      body: ListView(
        children: [
          ...
          RadioGroup<ThemeMode>(
            ...
            onChanged: (value) {
              if (value != null) {
                widget.appState.setThemeMode(value);
              }
            },
            child: const Column(
              children: [
                _ThemeTile(title: 'System Default', value: ThemeMode.system),
                _ThemeTile(title: 'Light Mode', value: ThemeMode.light),
                _ThemeTile(title: 'Dark Mode', value: ThemeMode.dark),
              ],
            ),
          ),
